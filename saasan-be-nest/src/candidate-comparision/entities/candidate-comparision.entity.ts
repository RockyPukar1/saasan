...
import { CandidateComparisionCriteriaEntity } from 'src/candidate-comparision-criteria/entities/candidate-comparision-criteria.entity';
import { ElectionCandidateEntity } from 'src/election-candidate/entities/election-candidate.entity';
