...
import { CreateCandidateComparisionCriterionDto } from '../dtos/create-candidate-comparision-criterion.dto';
import { UpdateCandidateComparisionCriterionDto } from '../dtos/update-candidate-comparision-criterion.dto';

@Controller('candidate-comparision-criteria')
export class CandidateComparisionCriteriaController {
  constructor(
    private readonly candidateComparisionCriteriaService: CandidateComparisionCriteriaService,
  ) {}
  ...
  create(
    ...
    return this.candidateComparisionCriteriaService.create(
      createCandidateComparisionCriterionDto,
    );
  }
  ...
  update(
    ...
    return this.candidateComparisionCriteriaService.update(
      +id,
      updateCandidateComparisionCriterionDto,
    );
  }
